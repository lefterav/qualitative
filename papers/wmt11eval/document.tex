...
\newcite{callisonburch-EtAl:2010:WMT}). %TODO: example example example
...
Whereas latest work, such as \newcite{Specia:2010:MTE:1842848.1842852}, has
...
\hline
\multicolumn{1}{|c|}{features} & \multicolumn{2}{c|}{naïve Bayes} &
\multicolumn{2}{c|}{knn}  \\
\hline
& rho & tau & rho & tau \\ 
\hline 
\multicolumn{1}{|c|} {basic experiment} & & & & \\
\hline
...
%unk, len, n_{parse}, $VP, conf_{bestparse}$ & 0.72 & 0.20 & 0.80 & 0.25  \\
unk, len, n$_{\text{parse}}$, VP, conf$_{\text{bestparse}}$ & 0.78 & 0.25 & 0.75
& 0.24 \\
%unk, len, n_{parse}, $NP, conf_{bestparse}$ & 0.75 & 0.21 & 0.78 & 0.23  \\
...
\\
\hline
\multicolumn{1}{|c|} {extended experiment} & & & & \\
\hline
...
= 0.39$ according to \newcite{callisonburch-EtAl:2010:WMT}.
...
\newcite{callisonburch-EtAl:2010:WMT}), when evaluated against reference
