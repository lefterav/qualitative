...
from featuregenerator.blackbox.parser.berkeley.berkeleyclient_ergun import BerkeleySocketFeatureGenerator, BerkeleyXMLRPCFeatureGenerator
    ...
    def get_parser(self, language):
        ...
        for parser_name in [section for section in self.sections() if section.startswith("parser:")]:
            if self.get(parser_name, "language") == language:
                ...
                print (parser_name, self.items(parser_name))
