...
class CohenKappa(object):
    ...
    def get_cohen_kappa(self, systems, rankingFile1, rankingFile2):
        """
        ...
        """
        psList1 = RankReader.get_rankings(RankReader(rankingFile1))
        psList2 = RankReader.get_rankings(RankReader(rankingFile2))
