...
if __name__ == '__main__':
    ...
    parser.add_argument('stem', 
                        help='the original entire corpus without the language suffix')
    parser.add_argument('--langsrc', dest='langsrc', 
                       help='source language file suffix')
    parser.add_argument('--langtgt', dest='langtgt',
                       help='target language file suffix')    
    parser.add_argument('--size', dest='size', type=int, default=3000, help='target size for keep out set')
    #threshold
    #minimum size
