...
if __name__ == '__main__':
    ...
    parser.add_argument('--all', help="Get statistics for all features")
    parser.add_argument('--parallel', matavar='PAR_FEATURES', nargs='*', help="The names of the parallel sentence features whose statistics will be calculated")
    ...
    if parser.all:
        print get_statistics(args.files,
                                    all_general =  True,
                                    all_target = True,
