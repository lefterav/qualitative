...
@files(None, 'deleteme.preprocessed.data')
def experiment_data_reader(input_file, output_file):
...
@files('deleteme.preprocessed.data', 'deleteme.pairwise.data')
def experiment_data_pairwiser(input_file, output_file):
    print "pairwise"  
    f = open(input_file, "r")
...
pipeline_run([experiment_data_pairwiser])
