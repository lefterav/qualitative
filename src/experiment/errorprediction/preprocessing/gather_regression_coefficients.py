...
mypath="/share/taraxu/selection-mechanism/errorprediction/learning/regression/langpairs/{langpair}/tgt-1_{errcat}.logreg.dump.txt"
...
for langpair in langpairs:
    print "\\begin{table*} \n "
    print "\\begin{tabular}{|lr|lr|lr|lr|} \n "
    print "\\multicolumn{{8}}{{c}}{{ {} }} \\\\ \\hline".format(langpair),
    print
