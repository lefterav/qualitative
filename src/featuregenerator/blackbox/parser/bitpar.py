...
class BitParChartParser:
	def __init__(self, lexicon_filename=None, grammar_filename=None, weightedrules=None, lexicon=None, rootsymbol="TOP", unknownwords=None, openclassdfsa=None, cleanup=True, n=10, name=''):
	...
	def start(self):
		...
		if self.lexicon_filename and self.grammar_filename:
			self.cmd += "-v %s %s" % (self.grammar_filename, self.lexicon_filename)
